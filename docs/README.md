...
3. [CHINESE_TEXT_IN_AGENT_WORKFLOW.md](./CHINESE_TEXT_IN_AGENT_WORKFLOW.md)
4. [HEADROOM_ZH_STRATEGY.md](./HEADROOM_ZH_STRATEGY.md)
5. [HEADROOM_KOMPRESS_ANALYSIS.md](./HEADROOM_KOMPRESS_ANALYSIS.md)

### 第三层：数据与风险参考

6. [CHINESE_KOMPRESS_DATA_CONSTRUCTION_PLAN.md](./CHINESE_KOMPRESS_DATA_CONSTRUCTION_PLAN.md)
7. [CHINESE_KOMPRESS_RISK_MAP.md](./CHINESE_KOMPRESS_RISK_MAP.md)
8. [AGENT_DOC_SOURCE_POOL_SPEC.md](./AGENT_DOC_SOURCE_POOL_SPEC.md)
9. [DATASET_800_EXPANSION_SOP.md](./DATASET_800_EXPANSION_SOP.md)
...
5. 扩量阶段按 [DATASET_800_EXPANSION_SOP.md](./DATASET_800_EXPANSION_SOP.md) 执行，优先走分层抽检而非全量人工重审。
