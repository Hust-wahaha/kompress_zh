...
5. [HF_MODEL_CARD_BASELINE_V1_RELEASE.md](./HF_MODEL_CARD_BASELINE_V1_RELEASE.md)
6. [HF_RELEASE_CHECKLIST_BASELINE_V1.md](./HF_RELEASE_CHECKLIST_BASELINE_V1.md)

### 第三层：配套背景

7. [CHINESE_TEXT_IN_AGENT_WORKFLOW.md](./CHINESE_TEXT_IN_AGENT_WORKFLOW.md)
8. [HEADROOM_ZH_STRATEGY.md](./HEADROOM_ZH_STRATEGY.md)
9. [HEADROOM_KOMPRESS_ANALYSIS.md](./HEADROOM_KOMPRESS_ANALYSIS.md)

### 第四层：数据与风险参考

10. [CHINESE_KOMPRESS_DATA_CONSTRUCTION_PLAN.md](./CHINESE_KOMPRESS_DATA_CONSTRUCTION_PLAN.md)
11. [CHINESE_KOMPRESS_RISK_MAP.md](./CHINESE_KOMPRESS_RISK_MAP.md)
12. [AGENT_DOC_SOURCE_POOL_SPEC.md](./AGENT_DOC_SOURCE_POOL_SPEC.md)
13. [DATASET_1K_WORKING_SPEC.md](./DATASET_1K_WORKING_SPEC.md)
14. [DATASET_800_EXPANSION_SOP.md](./DATASET_800_EXPANSION_SOP.md)
...
2. 优先以 [HF_MODEL_CARD_BASELINE_V1_RELEASE.md](./HF_MODEL_CARD_BASELINE_V1_RELEASE.md) 作为 HF 首版发布基底，而不是继续围绕 draft 版本改写。
3. 按 [HF_RELEASE_CHECKLIST_BASELINE_V1.md](./HF_RELEASE_CHECKLIST_BASELINE_V1.md) 补齐 HF 首版发布缺口，尤其是 license、上传形态、最小推理示例。
